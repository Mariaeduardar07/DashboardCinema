import styles from "./dashbboardContent.module.css";
    ...
    return (
        ...
        <div className={styles.summaryCards}>
          <div className={styles.card}>
            ...
            <div className={styles.cardChage + "" + styles.positive}>+15% em relação a ontem</div>
          </div>

          <div className={styles.card}>
            <h3>Arrecadação Mensal</h3>
            <div className={styles.cardValue}>R$ 345.780,00</div>
            <div className={styles.cardChage + "" + styles.positive}>+8% em relação ao mês passado</div>
          </div>

          <div className={styles.card}>
            <h3>Arrecadação Semestral</h3>
            <div className={styles.cardValue}>R$ 1.987.650,00</div>
            <div className={styles.cardChage + "" + styles.positive}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.cardChage + "" + styles.negative}>
